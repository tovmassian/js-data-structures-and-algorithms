...
import { IPriorityQueueElement } from '../../src/data-structures/PriorityQueue';
...
describe('PriorityQueue', () => {
  ...
  describe('constructor', () => {
    it('should create a priority queue with an element of 0 priority', () => {
      ...
      const queueElements: IPriorityQueueElement[] =
        newPriorityQueue.getQueueElements();
  ...
  describe('enqueue', () => {
    ...
    describe('when prioritized element is passed', () => {
      it('should add elements in prioritized order', () => {
        newPriorityQueue.enqueue({
          value: 'highestPriorityElement',
          priority: 3,
        });
        newPriorityQueue.enqueue({
          value: 'lowestPriorityElement',
          priority: 1,
        });
        newPriorityQueue.enqueue({
          value: 'mediumPriorityElement',
          priority: 2,
        });
        newPriorityQueue.enqueue({
          value: 'anotherMediumPriorityElement',
          priority: 2,
        });
